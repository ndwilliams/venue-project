...
from venueapi.models import Concert, Band, Venue
from django.contrib.auth.models import User

class ConcertTests(APITestCase):

    fixtures = ['users', 'tokens', 'concerts', 'bands', 'venues']
    ...
    def test_create_concert(self):
        ...
        self.assertEqual(json_response['venue'], 1)
    ...
    def test_update_concert(self):
        ...
        self.assertEqual(json_response['band'], 2)
        self.assertEqual(json_response['venue'], 2)
